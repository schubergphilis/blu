...
# -*- coding: utf-8 -*-
#
# BluApi documentation build configuration file, created by
# sphinx-quickstart on Fri Nov 20 17:09:13 2015.
#
...
latex_documents = [
  (master_doc, 'Blu.tex', 'Blu Documentation',
   'Anooshiravan Ahmadi', 'manual'),
]
...
man_pages = [
    (master_doc, 'blu', 'Blu Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Blu', 'Blu Documentation',
   author, 'Anooshiravan Ahmadi', 'One line description of project.',
   'Miscellaneous'),
]
